...
def mostrar(id):
   usuarior = Userscr.get_by_id(id)
   return render_template("form_mostrar.html",usuario_cr = usuarior)
...
def actualizar(id):
      usuarior = Userscr.get_by_id(id)
      return render_template("form_editar.html",usuario_cr = usuarior)
